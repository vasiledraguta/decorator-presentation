...
export function MiddlewarePipelineSlide() {
  return (
    <SlideLayout slideNumber={18} sectionLabel="WEB MIDDLEWARE: PIPELINE">
...
export function AuthDecoratorSlide() {
  return (
    <SlideLayout slideNumber={19} sectionLabel="WEB MIDDLEWARE: LOGIC">
      <div className="flex h-full flex-col gap-8">
        <div>
...
export function PipelineStackingSlide() {
  return (
    <SlideLayout slideNumber={20} sectionLabel="WEB MIDDLEWARE: STACKING">
      <div className="flex h-full flex-col gap-8">
        <div>
